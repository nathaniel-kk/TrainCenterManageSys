...
//判断身份证号
//$ageif (!function_exists('is_idcard')) {
    ...
    function getApp()
    {
        $config = [
            ...
            */
            ...
            |-----------------------------------------------------------
            */
            'app_secret' => 'q58SLxy-MPq1-a5ofJP3YIeBOmJppAfGpYrS9IfrnKw517Q3ndwhwa8GfvPep85j',
            ...
            */
            'oauth' => [
                 ...
                 */
                'app-01' => [
                    'client_id' => 'dingoabthjjpaqfsbblutq',
                    'client_secret' => 'thC0YjKKmo7ZvK7QVHuCiD6Dhze5ea0aRPf14mQWyKtMryslAtNxey18rmh8BYvw',
                    'scope' => 'snsapi_login',
                    'redirect' => 'http://blog.coderth.cn/views/html/funcation_home.html',
                ],
            ]
        ];
